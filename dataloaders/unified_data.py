...
class DatasetBase(data.Dataset):
    ...
    def tokenize_retriever(self, text=None, query=None, oracle=None):
        # Tokenize.
        if query:
    ...
    def __getitem__(self, index):
        if config.early_preprocess:
            retriever_inputs, generator_inputs, dialogue = self.features[index]
        else:
            session = self.features[index]
            retriever_inputs, generator_inputs, dialogue = self.preprocess(session)
...
class DialSumBase(DatasetBase):
    ...
    def __init__(self, mode, retriever_tokenizer, generator_tokenizer):
        ...
        #self.file_name = '/home/ubuntu/anaconda3/envs/dyle/DYLE/data/'
        ...
        with open(self.file_name) as f:
            ...
            for line in tqdm(f.readlines()):
                ...
                for query, summary, oracle in zip(queries, summaries, oracles):
                    ...
                    features.append((retriever_inputs, generator_inputs, dialogue))
