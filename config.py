...
class Config(object):
    ...
    def __init__(self):
        ...
        self.generator_name_or_path = {'dynamic-rag': 'facebook/bart-base',
                                       }[self.generator]
        ...
        # Directories.
        self.log_dir = self.model_specific_dir('/tmp/pycharm_project/DYLE/outputs/logs')
        remove_all_under(self.log_dir)
        self.save_model_dir = self.model_specific_dir('/tmp/pycharm_project/DYLE/outputs/saved_model')
        self.sample_dir = self.model_specific_dir('/tmp/pycharm_project/DYLE/outputs/sampled_results')
        self.tmp_dir = self.model_specific_dir('/tmp/pycharm_project/DYLE/outputs/temp_results')
